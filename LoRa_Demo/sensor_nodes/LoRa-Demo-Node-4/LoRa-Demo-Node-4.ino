...
static const PROGMEM u1_t NWKSKEY[16] ={ 0x53, 0xC9, 0xA0, 0x5A, 0x73, 0x08, 0x46, 0x52, 0x7C, 0x17, 0x31, 0xEB, 0xFA, 0xA1, 0xDA, 0xEB };
static const u1_t PROGMEM APPSKEY[16] ={ 0x0B, 0x54, 0x63, 0x47, 0x09, 0x47, 0xE7, 0xEE, 0x20, 0xBB, 0xAA, 0xE6, 0x1B, 0xEE, 0x34, 0x8B };
static const u4_t DEVADDR =0x26031209;
...
void setup() {
  ...
  debugSerial.println(F("[INFO] LoRa Demo Node 5 Demonstration"));
